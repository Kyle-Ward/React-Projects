...
class DashboardComponent extends React.Component {
  ...
  // Chat index could be different than the one we are currently on in the case that we are calling this function from within a loop such as the chatList. We will set a default value and can overwrite it when necessary.
  messageRead = () => {
